            ...
            <View className="mb-10 space-y-8">
              ...
              >
                <View className="flex-1 pr-6">
                  <Text className="text-2xl font-bold text-blue-700 mb-2">Yes, Skip to Van Selection</Text>
                  <Text className="text-gray-500 text-lg">I already know what van size I need</Text>
                </View>
              ...
              >
                <View className="flex-1 pr-6">
                  <Text className="text-2xl font-bold text-purple-700 mb-2">Build Item Inventory</Text>
                  <Text className="text-gray-500 text-lg">Search and add items from our database</Text>
                </View>
              ...
              >
                <View className="flex-1 pr-6">
                  <Text className="text-2xl font-bold text-emerald-700 mb-2">Use Tranzr Smart Detection</Text>
                  <Text className="text-gray-500 text-lg">Upload photos/videos to get accurate sizing</Text>
                </View>
