...
type InventoryCartModalProps = {
  visible: boolean;
  onClose: () => void;
};

const InventoryCartModal = ({ visible, onClose }: InventoryCartModalProps) => {
...
export default InventoryCartModal;
